...
import MainPlan from "../../../components/main-plan/main-plan.component";
...
const PlanDetail = ({ collection, match, isLoading, fetchPlanById }) => {
  console.log("plan detail rendering", match);
  ...
  return (
    <Suspense fallback={<Spinner />}>
      <Spinner data={collection} isLoading={isLoading}>
        <div className="col-md-5 col-lg-4 d-md-block">
        ...
        <div className="col">
          ...
          <Route path={`${match.path}/main-page`}>
            <MainPlan />
          </Route>
        </div>
      </Spinner>
